...
export const helplines: Helpline[] = [
  {
    ...
    tel: '1800-599-0019',
    hours: '24/7 (placeholder; verify before publishing)',
    reachOutNote: 'Call or text — free from any phone (placeholder; verify before publishing)',
    featured: true,
  },
  {
    id: 'vandrevala',
    ...
    tel: '1860-2662-345',
    hours: '24/7 (placeholder; verify before publishing)',
    reachOutNote: 'Call or WhatsApp (placeholder; verify before publishing)',
  },
  {
    id: 'icall',
    ...
    tel: '9152987821',
    hours: 'Mon–Sat (placeholder; verify before publishing)',
    reachOutNote: 'Call, email or chat (placeholder; verify before publishing)',
  },
  {
    id: 'aasra',
    name: 'AASRA',
    ...
    tel: '91-22-27546669',
    hours: '24/7 (placeholder; verify before publishing)',
    reachOutNote: 'Call — confidential, no need to give your name (placeholder; verify before publishing)',
  },
  {
    id: 'emergency-112',
